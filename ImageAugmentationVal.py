...
for item in classes:
    ...
    img_list = os.listdir('base/validation/' + img_class)

    # Copy images from the class train dir to the img_dir
    for image_id in img_list:
        # source path to image
        src = os.path.join('base/validation/' + img_class, image_id)
    ...
    path = tempDir
    save_path = 'base/validation/' + img_class
    ...
    num_aug_images_wanted = 600  # total number of images we want to have in each class
